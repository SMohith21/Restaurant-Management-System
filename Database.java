...
{
    public final static String STAFF_FILE = "src/dataFiles/staff.txt";
    public final static String MANAGER_FILE = "src/dataFiles/manager.txt";
    public final static String MENU_FILE = "src/dataFiles/menu_item.txt";
    public final static String REPORT_FILE = "src/dataFiles/reports/report_";
     ...
     ***************************************************************************/
     ...
     //public final static int WAGES = 4;
     
     public void editStaffData(int staffID, String newPassword, String newFirstName, String newLastName , int newWage) throws DatabaseException
     {
     ...
     public void addStaff(int newID, String newPassward, String newFirstName, String newLastName, boolean isManager ,int newWage) throws DatabaseException
     {
         Staff newStaff;
         if(isManager)
            newStaff = new Manager(newID, newLastName, newFirstName, newPassward ,newWage);
         else
            newStaff = new Employee(newID, newLastName, newFirstName, newPassward ,newWage);
    ...
    ***************************************************************************/
    ...
    private void loadStaffFile() throws DatabaseException
    {
            ...
            while (line != null) {
                ...
                String Wage = record[4].trim();              

                // Add the data from file to the registerCourses array list
                Employee rEmployee = new Employee(Integer.parseInt(id),lastName, firstName, passward, Integer.parseInt(Wage));
    ...
    private void loadManagerFile() throws DatabaseException
    {
        try {
            ...
            while (line != null) {
                ...
                String Wage = record[4].trim();  
                // Add the data from file to the registerCourses array list
                Manager rManager = new Manager(Integer.parseInt(id),lastName,firstName, passward,Integer.parseInt(Wage));
    ...
    ***************************************************************************/
    public void updateStaffFile(boolean isManager) throws DatabaseException
    {
        ...
        String          line;
        String          fileName;
        String          tempFileName = "src/dataFiles/temp.txt";
        ...
        try{
            ...
            while (it.hasNext())
            {
                ...
                writer.write(re.getID() + "," + re.getPassword() + "," + re.getFirstName() + "," + re.getLastName()+ "," + re.getWage()+"\r\n");
            }
            writer.flush();
            writer.close();
        }
    ...
    public String generateOrderReport( String todaysDate) throws DatabaseException
    {
        ...
        try{
            ...
            while (it.hasNext())
            {
                ...
                String output = String.format("Order ID:%4d  StaffName:%-30s  Total:Rs.%-5.2f Review:%-30s %s\r\n",
                                            re.getOrderID(),re.getStaffName(),totalOfEachOrder,re.getReview(), stateString);
                writer.write(output);
