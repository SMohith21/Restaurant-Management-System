...
public class Controller_GUI
{
     ...
     * Staff management
     **********************************************************/
    public boolean addNewStaff(int newID, String newPassword, String newFirstName, String newLastName, boolean isManager,int newWage)
    {
        ...
        try
        {
            cDatabase.addStaff(newID, newPassword, newFirstName, newLastName, isManager, newWage);
            return true;
        }
        catch(DatabaseException de)
        {
    ...
    public boolean updateStaff(int id, String newPassword, String newFirstName, String newLastName,int newWage)
    {
        try
        {
            cDatabase.editStaffData(id, newPassword, newFirstName, newLastName,newWage);
            return true;
        }
        catch(DatabaseException de)
        {
    ...
    public boolean addReview(int closeOrderID, String review){
        Order rOrder = cDatabase.findOrderByID(closeOrderID);
        rOrder.setReview(review);
        return true;
    ...
    public  ArrayList<String>  createStaffList()
    {
        ...
        while (it.hasNext()) {
            ...
            String output = String.format("Staff ID:%4d  Name:%-25s Wage:%4d  ",
                                            re.getID(), fullName , Wage);
    ...
    public ArrayList<String>  createOrderList()
    {
        ...
        while (it.hasNext()) {
            ...
            output = String.format("Order ID:%4d  StaffName:%-20s  Total:Rs.%5.2f State:%-8s Review:%-20s \n",
                                            re.getOrderID(),re.getStaffName(),re.getTotal(),state,re.getReview());
            initData.add(output);
        }
        if(initData.isEmpty())
